import 'package:bus_management_system/fuel.dart';
import 'package:flutter/material.dart';
import 'package:firebase_auth/firebase_auth.dart';
import 'package:google_fonts/google_fonts.dart';
import 'driver_leave_status.dart';
import 'bus_inventory.dart';
import 'fuel_location.dart';

class DriversHome extends StatelessWidget {
  final User? currentUser = FirebaseAuth.instance.currentUser;

  DriversHome({super.key});
                  ...
                  child: Align(
                    ...
                    child: Column(
                      ...
                      children: [
                        ...
                        Text(
                          '${currentUser?.email?.split('@')[0].driversHomeCapitalize() ?? 'Driver'}!',
                          style: GoogleFonts.poppins(
                            textStyle: TextStyle(
                              fontSize: 28,
                          ...
                          child: ListView(
                            children: [
                              ...
                              _buildOptionCard(
                                ...
                                subtitle:
                                    'Request time off and check leave status',
                                ...
                                onTap: () {
                                  Navigator.push(
                                    context,
                                    MaterialPageRoute(
                                      builder: (context) => DriverLeaveStatus(),
                                    ),
                                  );
                                },
                              ),
                              ...
                              // Fuel Stations Option
                              _buildOptionCard(
                                context,
                                title: 'Fuel Stations',
                                subtitle: 'View nearby partner fuel stations',
                                ...
                                onTap: () {
                                  Navigator.push(
                                    context,
                                    MaterialPageRoute(
                                      builder: (context) => FuelStationsPage(),
                                    ),
                                  );
                                },
                              ),
                              ...
                              // Fuel Cost Update Option
                              _buildOptionCard(
                                context,
                                title: 'Fuel Cost Update',
                                subtitle: 'Update recent fuel expenses',
                                ...
                                onTap: () {
                                  Navigator.push(
                                    context,
                                    MaterialPageRoute(
                                      builder: (context) => FuelCostUpdate(),
                                    ),
                                  );
                                },
                              ),
                              ...
                              // Bus Parts Inventory Option
                              _buildOptionCard(
                                context,
                                title: 'Bus Parts Inventory',
                                subtitle:
                                    'Check available parts and request new ones',
                                icon: Icons.build,
                                gradientColors: [
                                  Color(0xFFE67E22),
                                  Color(0xFFD35400),
                                ...
                                onTap: () {
                                  Navigator.push(
                                    ...
                                    MaterialPageRoute(
                                      builder:
                                          (context) =>
                                              BusPartsInventory(isAdmin: false),
                                    ),
                                  );
                                },
                              ),
